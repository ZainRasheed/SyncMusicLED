...
//  pinMode(ANAL_IN, INPUT);
//  // put your setup code here, to run once:
//  Serial.begin(9600);
//}
//
//void loop() {
////  digitalValue = digitalRead(DIGI_IN);
////  Serial.println(digitalValue);
////  delay(140);
//  analogValue = analogRead(ANAL_IN);
...
void loop()
{
  ...
  if((s>=350)&&(s<=400))
  {
   ...
   {
     leds[14]=CRGB (138,43,226);
    leds[15]=CRGB (138,43,226);
   }
//   else if((s>445)&&(s<470))
//   {  
//    for(int k=0;k<30;k++)
...
//  Color nc = pitchConv(newPitch, (analogRead(PITCH_PIN)/5));
//
